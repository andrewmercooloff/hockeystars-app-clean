        ...
        <TouchableWithoutFeedback onPress={Keyboard.dismiss}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput
              ...
              placeholder={t('register.name').toUpperCase()}
              placeholderTextColor="#888"
          ...
          <View style={styles.inputContainer}>
            ...
            >
              <Text style={styles.countryButtonText}>
                {formData.country ? (t(`countries.${normalizeCountryName(formData.country)}`) || formData.country) : t('profile.selectCountry')}
              </Text>
          ...
          {/* Фото профиля */}
          <View style={styles.inputContainer}>
            <Text style={styles.label}>{t('register.photo')}</Text>
            <View style={styles.photoContainer}>
              {formData.avatar ? (
                ...
                <View style={styles.photoPlaceholder}>
                  ...
                  <Text style={styles.photoPlaceholderText}>{t('register.selectPhoto')}</Text>
                </View>
              )}
              <TouchableOpacity style={styles.photoButton} onPress={pickImage}>
                <Text style={styles.photoButtonText}>{t('register.selectPhoto')}</Text>
              </TouchableOpacity>
            </View>
          </View>
              ...
              {filteredCountries.map((country) => (
                ...
                >
                  <Text style={[
                    ...
                    {t(`countries.${normalizeCountryName(country)}`) || country}
                  </Text>
                </TouchableOpacity>
              ))}
            </ScrollView>
