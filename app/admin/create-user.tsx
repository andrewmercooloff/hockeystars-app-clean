...
export default function CreateUserScreen() {
  ...
  console.log('Admin create user - Current language:', language);
  console.log('Admin create user - playerNumber translation:', t('profile.playerNumber'));
  console.log('Admin create user - heightWithUnit translation:', t('profile.heightWithUnit'));
  console.log('Admin create user - weightWithUnit translation:', t('profile.weightWithUnit'));
  ...
  const handleCreateUser = async () => {
    ...
    try {
      const createdPlayer = await createPlayerManually(
        ...
        'admin' // Используем фиксированный ID администратора
      );
            ...
            <View style={styles.formContainer}>
              ...
              >
                {formData.avatar ? (
                  ...
                  <View style={styles.avatarPlaceholder}>
                    ...
                    <Text style={styles.avatarPlaceholderText}>{t('createUser.addPhoto')}</Text>
                  </View>
                )}
              </TouchableOpacity>
              ...
              <View style={styles.inputContainer}>
                ...
                <View style={styles.pickerContainer}>
                  {['player', 'coach', 'scout', 'star'].map((status) => (
                    <TouchableOpacity
                      key={status}
                      style={[
                        styles.pickerOption,
                    ...
                    >
                      <Text style={[
                        ...
                        {status === 'player' ? t('createUser.player') : 
                         ...
                         status === 'scout' ? t('createUser.scout') : t('createUser.star')}
                      </Text>
                    </TouchableOpacity>
                  ))}
                </View>
              ...
              {/* Имя */}
              <View style={styles.inputContainer}>
                <Text style={styles.label}>{t('createUser.name')}</Text>
                <TextInput
                  style={styles.input}
                  value={formData.name}
                  onChangeText={(text) => {
