  ...
  const handleGiftRequest = async (request: GiftRequestItem, action: 'accept' | 'decline') => {
    try {
      ...
      if (action === 'accept') {
        ...
        try {
          await supabase
            ...
            .insert([{
              ...
              type: 'gift_accepted',
              title: t('notifications.giftRequestApproved'),
              message: t('notifications.giftRequestApprovedMessage', { 
                itemType: getItemTypeName(requestData.item_type), 
                starName: currentUser?.name || t('notifications.star') 
              }),
              is_read: false,
              data: { 
                item_id: newItem.id, 
        ...
        Alert.alert(t('common.success'), t('notifications.giftRequestAccepted'));
      } else {
        ...
        Alert.alert(t('common.success'), t('notifications.giftRequestRejected'));
      }
