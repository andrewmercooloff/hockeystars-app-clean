...
export function localizeExercise(exercise: Exercise, language: Language): LocalizedExercise {
  return {
    ...
    category: language === 'ru' ? (exercise.categoryRu || exercise.category) : (exercise.categoryEn || exercise.category),
    duration: language === 'ru' ? (exercise.durationRu || exercise.duration) : (exercise.durationEn || exercise.duration),
    difficulty: language === 'ru' ? (exercise.difficultyRu || exercise.difficulty) : (exercise.difficultyEn || exercise.difficulty),
    imageUrl: exercise.imageUrl,
    
    // Локализованные поля
    title: language === 'ru' ? exercise.titleRu : exercise.titleEn,
    description: language === 'ru' ? exercise.descriptionRu : exercise.descriptionEn,
    benefits: language === 'ru' ? exercise.benefitsRu : exercise.benefitsEn,
    instructions: language === 'ru' ? exercise.instructionsRu : exercise.instructionsEn,
    tips: language === 'ru' ? exercise.tipsRu : exercise.tipsEn,
    equipment: language === 'ru' ? exercise.equipmentRu : exercise.equipmentEn,
    calories: language === 'ru' ? exercise.caloriesRu : exercise.caloriesEn,
